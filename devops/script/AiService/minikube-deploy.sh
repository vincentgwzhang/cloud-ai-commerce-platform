...
IMAGE="${AI_SERVICE_IMAGE:-${AI_SERVICE_DEFAULT_IMAGE}}"
...
echo "==> AiService done"
echo "    Chroma must be running on the host: docker compose -f devops/script/docker-compose-observability-minikube.yml up -d chroma"
echo "    minikube service ai-service --url"
