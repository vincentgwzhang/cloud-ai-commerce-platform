package com.vincent.productservice.observability;
...
public final class MdcSupport {
    ...
    public static void putBusinessContext(String orderNo, String productCode, String eventId) {
        put(MdcKeys.ORDER_NO, orderNo);
        put(MdcKeys.PRODUCT_CODE, productCode);
        put(MdcKeys.EVENT_ID, eventId);
    }

    public static void clearBusinessContext() {
        remove(MdcKeys.ORDER_NO);
